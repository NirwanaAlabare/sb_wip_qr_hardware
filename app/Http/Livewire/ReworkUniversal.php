...
class ReworkUniversal extends Component
{
    ...
    public function render(SessionManager $session)
    {
        ...
        $this->allDefectPosition = Defect::selectRaw('output_defects.*')->where('output_defects.defect_status', 'defect')->
            leftJoin('master_plan', 'master_plan.id', '=', 'output_defects.master_plan_id')->
            where('output_defects.defect_status', 'defect')->
            where('master_plan.sewing_line', Auth::user()->username)->
            where('master_plan.tgl_plan', $this->orderDate)->
        ...
        $allDefectList = Defect::selectRaw('MIN(output_defects.master_plan_id) master_plan_id, output_defects.defect_type_id, output_defects.defect_area_id, output_defect_types.defect_type, output_defect_areas.defect_area, count(*) as total')->
            leftJoin('master_plan', 'master_plan.id', '=', 'output_defects.master_plan_id')->
        ...
        $defects = Defect::selectRaw('output_defects.*, master_plan.gambar, so_det.size as so_det_size, output_defect_types.defect_type, output_defect_areas.defect_area')->
            leftJoin('master_plan', 'master_plan.id', '=', 'output_defects.master_plan_id')->
            leftJoin('so_det', 'so_det.id', '=', 'output_defects.so_det_id')->
            leftJoin('output_defect_areas', 'output_defect_areas.id', '=', 'output_defects.defect_area_id')->
            leftJoin('output_defect_types', 'output_defect_types.id', '=', 'output_defects.defect_type_id')->
        ...
        $reworks = ReworkModel::selectRaw('output_reworks.*, so_det.size as so_det_size, output_defects.defect_status, master_plan.gambar, output_defects.defect_area_x, output_defects.defect_area_y, output_defect_types.defect_type, output_defect_areas.defect_area')->

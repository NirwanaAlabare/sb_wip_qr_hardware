...
class ReworkUniversal extends Component
{
    ...
    public function render(SessionManager $session)
    {
        ...
        $allDefectList = DB::connection('mysql_sb')->table('output_defects')->selectRaw('MIN(output_defects.master_plan_id) master_plan_id, output_defects.defect_type_id, output_defects.defect_area_id, output_defect_types.defect_type, output_defect_areas.defect_area, count(*) as total')->
            leftJoin('master_plan', 'master_plan.id', '=', 'output_defects.master_plan_id')->

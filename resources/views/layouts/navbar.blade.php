                    ...
                    <div class="col-md-auto">
                        <li class="nav-item dropdown w-100">
                            <button class="btn btn-sm bg-white dropdown-toggle w-100" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span>{{ strtoupper(substr(Auth::user()->name, 0, 8)).(strlen(Auth::user()->name) > 8 ? '...' : '') }}</span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" onclick="logout('{{ route('unauthenticate') }}')"><i class="fa-solid fa-arrow-right-from-bracket"></i> Log Out</a></li>
                            </ul>
                        </li>
                    </div>
                    <div class="col-md-auto">
                        <li class="nav-item w-100">
                            <a class="btn btn-no btn-sm" onclick="logout('{{ route('unauthenticate') }}')">Log Out</a>
                        </li>
                    </div>
                </div>
            </ul>
